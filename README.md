...
This repository contains the **README.md**, the **LICENSE**, the compiled **UniversalPointerSearcher.exe** (**Windows** version), the **DLLs** for the **Windows** version, the **UniversalpointerSearcher.macho** (**MacOS X** version) and the compiled **UniversalPointerSearcher.elf** (**Linux** version).
